    ...
    >
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <div className="shrink-0 w-12 h-12 bg-gradient-to-br from-emerald-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform duration-300">
