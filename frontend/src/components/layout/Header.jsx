...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    ...
    <header className="sticky top-0 z-50 w-full h-16 bg-white/80 backdrop-blur-xl border-b border-slate-200/60">
        ...
        <div className="flex items-center gap-4 ml-auto">
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-slate-200/60">
            ...
            <div className="flex items-center gap-3 px-3 py-1.5 rounded-xl hover:bg-slate-50 transition-colors duration-200 cursor-pointer group">
              ...
              {/* User Icon */}
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-white shadow-md shadow-emerald-500/20 group-hover:shadow-emerald-500/40 transition-all duration-200">
