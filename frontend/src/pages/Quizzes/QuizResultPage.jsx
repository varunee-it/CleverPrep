    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        {detailedResults.map((result, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl p-6 shadow-lg shadow-slate-200"
            >
              <div className="flex items-start justify-between gap-4 mb-3">
                ...
                <div
                  className={`shrink-0 w-10 h-10 rounded-xl flex items-center justify-center ${isCorrect
              ...
              {result.explanation && (
                <div className="p-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl">
                  <div className="flex items-start gap-3">
                    <div className="shrink-0 w-8 h-8 rounded-lg bg-slate-200 flex items-center justify-center at-0.5">
                      <BookOpen className="w-4 h-4 text-slate-600" strokeWidth={2} />
                    </div>

                    <div className="flex-1">
                      <p className="text-xs ont-semibold text-salte-600 uppercase tracking-wide mb-1">
                        Explanation
                      </p>
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${quiz.document._id}`}>
          <button className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 sahdow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden">
